...
E2E_FOCUS ?= fast
IMG_UPGRADE_FROM ?= ubuntu-2204-kubernetes-v1.30.14-2025-08-28
IMG_UPGRADE_TO ?= ubuntu-2204-kubernetes-v1.31.12-2025-08-27
...
controller-gen: ## Download controller-gen
	GOPATH=$(GET_GOPATH) CONTROLLER_GEN_VERSION=${CONTROLLER_GEN_VERSION} ./hack/ensure-controller-gen.sh

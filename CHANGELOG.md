...
## [v1.5.3](https://github.com/outscale/cluster-api-provider-outscale/releases/tag/v1.5.3) - 2026-09-22

### 🐛 Fixed
* 🐛 fix: persist finalizer immediatly to avoid orphaned resources (backport) by @jfbus in https://github.com/outscale/cluster-api-provider-outscale/pull/921

...
//
//	mockgen -destination mock_storage/volume_mock.go -package mock_storage -source ./volume.go
//
...
func (mr *MockOscVolumeInterfaceMockRecorder) CheckVolumeState(ctx, clockInsideLoop, clockLoop, state, volumeId any) *gomock.Call {
...
func (mr *MockOscVolumeInterfaceMockRecorder) CreateVolume(ctx, spec, volumeName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOscVolumeInterfaceMockRecorder) DeleteVolume(ctx, volumeId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOscVolumeInterfaceMockRecorder) GetVolume(ctx, volumeId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOscVolumeInterfaceMockRecorder) LinkVolume(ctx, volumeId, vmId, deviceName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOscVolumeInterfaceMockRecorder) UnlinkVolume(ctx, volumeId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOscVolumeInterfaceMockRecorder) ValidateVolumeIds(ctx, volumeIds any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

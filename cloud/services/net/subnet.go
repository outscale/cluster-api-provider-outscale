...
type OscSubnetInterface interface {
	CreateSubnet(ctx context.Context, spec infrastructurev1beta1.OscSubnet, netId, clusterID string) (*osc.Subnet, error)
...
func (s *Service) CreateSubnet(ctx context.Context, spec infrastructurev1beta1.OscSubnet, netId, clusterID string) (*osc.Subnet, error) {

...
//
//	mockgen -destination mock_net/route_mock.go -package mock_net -source ./route.go
//
...
func (m *MockOscRouteTableInterface) CreateRoute(ctx context.Context, destinationIpRange, routeTableId, resourceId string, targetType v1beta2.OscTargetType) (*osc.RouteTable, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOscRouteTableInterfaceMockRecorder) CreateRoute(ctx, destinationIpRange, routeTableId, resourceId, targetType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateRoute", reflect.TypeOf((*MockOscRouteTableInterface)(nil).CreateRoute), ctx, destinationIpRange, routeTableId, resourceId, targetType)
}

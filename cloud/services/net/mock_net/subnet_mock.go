...
func (m *MockOscSubnetInterface) CreateSubnet(ctx context.Context, spec v1beta1.OscSubnet, netId, clusterID string) (*osc.Subnet, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateSubnet", ctx, spec, netId, clusterID)
...
func (mr *MockOscSubnetInterfaceMockRecorder) CreateSubnet(ctx, spec, netId, clusterID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateSubnet", reflect.TypeOf((*MockOscSubnetInterface)(nil).CreateSubnet), ctx, spec, netId, clusterID)
}

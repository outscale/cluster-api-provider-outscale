...
//
//	mockgen -destination mock_compute/securitygroup_mock.go -package mock_compute -source ./securitygroup.go
//
...
func (m *MockOscSecurityGroupInterface) CreateSecurityGroup(ctx context.Context, netId, clusterID, securityGroupName, securityGroupDescription, securityGroupTag string, roles []v1beta2.OscRole) (*osc.SecurityGroup, error) {
	m.ctrl.T.Helper()
...
func (m *MockOscSecurityGroupInterface) CreateSecurityGroupRule(ctx context.Context, securityGroupId, flow, ipProtocol, ipRange, securityGroupMemberId string, fromPortRange, toPortRange int) (*osc.SecurityGroup, error) {
	m.ctrl.T.Helper()
...
func (m *MockOscSecurityGroupInterface) DeleteSecurityGroupRule(ctx context.Context, securityGroupId, flow, ipProtocol, ipRange, securityGroupMemberId string, fromPortRange, toPortRange int) error {
	m.ctrl.T.Helper()
...
func (m *MockOscSecurityGroupInterface) SecurityGroupHasRule(ctx context.Context, securityGroupId, flow, ipProtocols, ipRanges, securityGroupMemberId string, fromPortRanges, toPortRanges int) (bool, error) {
	m.ctrl.T.Helper()

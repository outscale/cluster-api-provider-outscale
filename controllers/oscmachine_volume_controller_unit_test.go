...
func TestReconcileVolumeCreate(t *testing.T) {
	volumeTestCases := []struct {
		...
		},
		{
			...
			expCheckVolumeStateAvailableErr:   nil,
			expReadTagErr:                     nil,
			expReconcileVolumeErr:             errors.New("cannot create volume: CreateVolume generic error"),
		},
		{
		...
		},
		{
			...
			expReadTagErr:                     nil,
			expReconcileVolumeErr:             errors.New("cannot get volume available: CheckVolumeStateAvailable generic error"),
		},
	}
	for _, vtc := range volumeTestCases {
		t.Run(vtc.name, func(t *testing.T) {
...
func TestReconcileVolumeGet(t *testing.T) {
	volumeTestCases := []struct {
		...
		},
		{
			...
			expValidateVolumeIdsErr: nil,
			expReadTagErr:           errors.New("ReadTag generic error"),
			expReconcileVolumeErr:   errors.New("cannot get tag: ReadTag generic error"),
		},
	}
	for _, vtc := range volumeTestCases {
		t.Run(vtc.name, func(t *testing.T) {
...
func TestReconcileDeleteVolumeDelete(t *testing.T) {
	volumeTestCases := []struct {
		...
		},
		{
			...
			expUnlinkVolumeErr:              nil,
			expCheckVolumeStateUseErr:       nil,
			expReconcileDeleteVolumeErr:     errors.New("cannot delete volume volume-test-volume-uid: DeleteVolume generic error"),
		},
	}
	for _, vtc := range volumeTestCases {
		t.Run(vtc.name, func(t *testing.T) {
...
func TestReconcileDeleteVolumeGet(t *testing.T) {
	volumeTestCases := []struct {
		...
		},
		{
			...
			expReconcileDeleteVolumeErr: errors.New("cannot validate volume id: ValidateVolumeIds generic errors"),
		},
		{
...
func TestReconcileDeleteVolumeUnlink(t *testing.T) {
	volumeTestCases := []struct {
	...
	}{
		{
			...
			expReconcileDeleteVolumeErr:       errors.New("cannot get volume volume-test-volume-uid in use: VolumeState generic error"),
		},
		{
			...
			expCheckVolumeStateUseFound:       true,
			expDeleteVolumeFound:              false,
			expReconcileDeleteVolumeErr:       errors.New("cannot unlink volume volume-test-volume-uid in use: UnlinkVolume generic error"),
		},
		{
			name:        "failed to delete volume",
			clusterSpec: defaultClusterReconcile,
			...
			expCheckVolumeStateUseFound:       true,
			expDeleteVolumeFound:              false,
			expReconcileDeleteVolumeErr:       errors.New("cannot get volume volume-test-volume-uid available: VolumeState generic error"),
		},
	}

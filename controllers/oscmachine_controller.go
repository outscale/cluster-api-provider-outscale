...
func (r *OscMachineReconciler) reconcile(ctx context.Context, machineScope *scope.MachineScope, clusterScope *scope.ClusterScope) (reconcile.Result, error) {
	...
	if !machineScope.Cluster.Status.InfrastructureReady {
		...
		v1beta1conditions.MarkFalse(oscmachine, infrastructurev1beta2.VmReadyCondition, infrastructurev1beta2.WaitingForClusterInfrastructureReason, clusterv1.ConditionSeverityInfo, "")
	...
	switch {
	case err != nil:
		v1beta1conditions.MarkFalse(oscmachine, infrastructurev1beta2.VmReadyCondition, infrastructurev1beta2.VmNotReadyReason, clusterv1.ConditionSeverityWarning, "%s", err.Error())
		return reconcile.Result{}, err
	case !reconcileVm.IsZero():
		v1beta1conditions.MarkFalse(oscmachine, infrastructurev1beta2.VmReadyCondition, infrastructurev1beta2.VmNotReadyReason, clusterv1.ConditionSeverityWarning, "VM is not running yet")
		return reconcileVm, nil
	default:
		v1beta1conditions.MarkTrue(oscmachine, infrastructurev1beta2.VmReadyCondition)
		return reconcile.Result{}, nil
	}
}

...
const (
	// NameOutscaleProviderPrefix is is outscale provider prefix name.
	NameOutscaleProviderPrefix = "capo-"
	// NameOutscaleProvider is outscale provider name.
	NameOutscaleProvider = NameOutscaleProviderPrefix + "cluster-"
	// APIServerRoleTagValue is the apiserver role tag.
	APIServerRoleTagValue = "apiserver"
	// NodeRoleTagValue is node role tag.
